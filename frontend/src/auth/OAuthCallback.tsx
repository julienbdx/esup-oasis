 ...
 * transmet le payload en mémoire (jamais en sessionStorage, où le token serait
 * lisible par tout script de l'origine), puis revient à la racine via une navigation
