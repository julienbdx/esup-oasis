...
export function AuthProvider({
  ...
  // d'authentification (l'API revalide chaque requête) — ne jamais y adjoindre de donnée
  // sensible. Sa suppression complète nécessiterait un endpoint backend « utilisateur courant ».
